  ...
  return (
    <div className='flex flex-col gap-4'>
      <div className='grid grid-cols-5 gap-4'>
        ...
        }} className='mr-auto text-indigo-400 text-lg sm:text-xl duration-200 hover:opacity-60'><i className="fa-solid fa-circle-chevron-right"></i></button>
        <p className={'text-center col-span-3 capitalized whitespace-nowrap textGradient '+fugaz.className}>{selectedMonth}</p>
        <button onClick={()=>{
          handleIncrementMonth(+1)
